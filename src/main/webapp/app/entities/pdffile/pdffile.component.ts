...
export class PdffileComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number): void {
    ...
    this.pdffileService
      ...
      .subscribe(
        (res: HttpResponse<IPdffile[]>) => this.onSuccess(res.body, res.headers, pageToLoad),
        () => this.onError()
      );
  }
  ...
  trackId(index: number, item: IPdffile): number {
  ...
  registerChangeInPdffiles(): void {
    this.eventSubscriber = this.eventManager.subscribe('pdffileListModification', () => this.loadPage());
  }

  delete(pdffile: IPdffile): void {
  ...
  protected onSuccess(data: IPdffile[] | null, headers: HttpHeaders, page: number): void {
    this.totalItems = Number(headers.get('X-Total-Count'));
    this.page = page;
    this.router.navigate(['/pdffile'], {
      queryParams: {
        page: this.page,
        size: this.itemsPerPage,
